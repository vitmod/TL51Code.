...
public class AudioFormat {
   ...
   /** @hide */
    public static final int ENCODING_TRUEHD= 8;
   /** Audio data format: DTS-HD compressed */
   /** @hide */
    public static final int ENCODING_DTSHD = 9;
   /** Audio data format: DTS-HD Master Audio compressed */
   /** @hide */
    public static final int ENCODING_DTSHD_MA = 10;
    ...
    public static boolean isValidEncoding(int audioFormat)
    {
        ...
        case ENCODING_E_AC3:
        case ENCODING_DTS:
        case ENCODING_TRUEHD:
        case ENCODING_DTSHD:
        case ENCODING_DTSHD_MA:
            return true;
        default:
            return false;
        }
