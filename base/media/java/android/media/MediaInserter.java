...
public class MediaInserter {
	...
	//Added by TCL mail:huyq@tcl.com for bulkinsert change
    ...
    public MediaInserter(IContentProvider provider, int bufferSizePerUri, int bufferSizeAudioUri,String packageName) {
        mProvider = provider;
