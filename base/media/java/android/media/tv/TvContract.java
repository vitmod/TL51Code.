...
public final class TvContract {
    ...
    public static final class Programs implements BaseTvColumns {
        ...
        /**
         * The flag indicating whether this program is appointed by user.
         * <p>
         * A value of 1 indicates the program is appointed
         *  a value of 0 indicates the program is not appointed. If
         * not specified, this value is set to 0 (not appointed) by default.
         * </p><p>
         * Type: INTEGER (boolean)
         * </p>
         * @hide
         */
        public static final String COLUMN_DROIDLOGIC_IS_APPOINTED = "droidlogic_is_appointed";
