...
public final class AudioAttributes implements Parcelable {
    ...
    public final static int USAGE_USB_HEADSET= 16;
    public final static int USAGE_USB_MIC= 17;
        ...
        public Builder setInternalLegacyStreamType(int streamType) {
            switch(streamType) {
                ...
                case AudioSystem.STREAM_TTS:
                    mContentType = CONTENT_TYPE_SPEECH;
                    break;
                case AudioSystem.STREAM_USB_HEADSET:
                     mContentType = CONTENT_TYPE_MUSIC;
                     break;
                case AudioSystem.STREAM_USB_MIC:
                    mContentType = CONTENT_TYPE_MUSIC;
                    break;
                default:
    ...
    public static String usageToString(int usage) {
        switch(usage) {
            ...
            case USAGE_USB_HEADSET:
                return new String("USAGE_USB_HEADSET");
            case USAGE_USB_MIC:
                return new String("USAGE_USB_MIC");
            default:
    ...
    public static int usageForLegacyStreamType(int streamType) {
        switch(streamType) {
            ...
            case AudioSystem.STREAM_USB_HEADSET:
                return USAGE_USB_HEADSET;
            case AudioSystem.STREAM_USB_MIC:
                return USAGE_USB_MIC;
            default:
    ...
    public static int toLegacyStreamType(AudioAttributes aa) {
        ...
        switch (aa.getUsage()) {
            ...
            case USAGE_USB_HEADSET:
                return AudioSystem.STREAM_USB_HEADSET;
            case USAGE_USB_MIC:
                return AudioSystem.STREAM_USB_MIC;
            case USAGE_UNKNOWN:
            default:
                return AudioSystem.STREAM_MUSIC;
        }
