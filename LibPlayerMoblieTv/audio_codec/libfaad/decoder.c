...
NEXT_CHECK:
    ...
    if (hDecoder->adts_header_present) {
        ...
        adts_frame_length = adts.aac_frame_length;
    ...
    /*if consumed large than aac frame length 100byte,think this frame had error*/
    if (adts_frame_length && hInfo->bytesconsumed - adts_frame_length > 100) {
        audio_codec_print("The decoder consumed more data than adts frame length,bytesconsumed=%d,adts_frame_length=%d\n",
        hInfo->bytesconsumed,adts_frame_length);
        hInfo->bytesconsumed = adts_frame_length;
        hInfo->error = 32;
        goto error;
    }
