...
static int reset_pcr_regs(void)
{
	...
	if (pcr_num != curr_pcr_num) {
		...
		if (READ_MPEG_REG(TS_HIU_CTL_2) & 0x80) {
			WRITE_MPEG_REG(PCR90K_CTL_2, pcr_regs);
