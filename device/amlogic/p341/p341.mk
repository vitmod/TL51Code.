...
$(call inherit-product, device/amlogic/p341/device.mk)
...
PRODUCT_AML_SECUREBOOT_USERKEY := ./uboot/board/amlogic/txl_p341_v1/aml-user-key.sig
PRODUCT_AML_SECUREBOOT_SIGNTOOL := ./uboot/fip/txl/aml_encrypt_txl
...
PRODUCT_COPY_FILES += \
    device/amlogic/p341/fstab.verity.amlogic:root/fstab.amlogic
else
PRODUCT_COPY_FILES += \
    device/amlogic/p341/fstab.amlogic:root/fstab.amlogic
endif
#########################################################################
#
#                                                WiFi
...
BOARD_USE_TELEVISON_AUDIO := true

ifeq ($(BOARD_USE_TELEVISON_AUDIO), true)
PRODUCT_PROPERTY_OVERRIDES += \
