...
static void *alsa_playback_loop(void *args)
{
	...
	//wujiaxi added at 20161115 start
    ...
    if ((property_get("media.amplayer.boot_vol",value,NULL) > 0) && (property_get("persist.media.audio.volumeindex",value1,"8") > 0)) {
        alsa_default_vol = atof(value)*atoi(value1)/15;
		//wujiaxi added at 20161115 end
