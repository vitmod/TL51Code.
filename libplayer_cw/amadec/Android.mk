...
include $(CLEAR_VARS)
LOCAL_PREBUILT_LIBS := audio_out/audio_effect/lib_aml_agc.a
...
LOCAL_SRC_FILES := \
           adec-external-ctrl.c adec-internal-mgt.c adec-ffmpeg-mgt.c adec-message.c adec-pts-mgt.c feeder.c adec_write.c adec_read.c\
           dsp/audiodsp-ctl.c audio_out/audio_effect/aml_agc.c audio_out/android-out.cpp audio_out/aml_resample.c audiodsp_update_format.c spdif_api.c pcmenc_api.c \
           dts_transenc_api.c dts_enc.c adec_omx_brige.c ../amavutils/amconfigutils.c  adec-wfd.c
...
LOCAL_SRC_FILES := \
           adec-external-ctrl.c adec-internal-mgt.c adec-ffmpeg-mgt.c adec-message.c adec-pts-mgt.c feeder.c adec_write.c adec_read.c\
           dsp/audiodsp-ctl.c audio_out/audio_effect/aml_agc.c audio_out/android-out.cpp audio_out/aml_resample.c  audiodsp_update_format.c \
...
###################################################
LOCAL_STATIC_LIBRARIES := lib_aml_agc
