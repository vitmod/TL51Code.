                      ...
                      const uint8_t *buf, int buf_size)
{
    ...
    for(i=0; i<=buf_size; i++){
        if((state&0xFFFFFF1F) == 0x107)
            has_sps=1;
        else if((state&0xFFFFFF1F) == 0x108)
            has_pps=1;
/*        if((state&0xFFFFFF1F) == 0x101 || (state&0xFFFFFF1F) == 0x102 || (state&0xFFFFFF1F) == 0x105){
        }*/
        else if((state&0xFFFFFF00) == 0x100
            && ((state&0xFFFFFF1F) != 0x106 || has_pps) /*NAL_SEI*/
            && (state&0xFFFFFF1F) != 0x109 /*NAL_AUD*/
            && (state&0xFFFFFF1F) != 0x10d /*NAL_SPS_EXT*/
